...
if __name__ == "__main__":
    ...
    dt = 2e-1
    max_l = int(input_len * (1 / dt)) + 1 # why? 2 * 5 + 1 = 11
    ...
    d_str = args.dataset
    # TODO change name
    full_save_name = f"globalExternalAttention{save_name}{args.hidden_size}G{args.n_gnn_layers}{d_str[0].upper() + d_str[1:]}{args.add_name}"
    print(f'----------------------------------------------------')
