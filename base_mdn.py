import sys
sys.path.insert(0, '/mnt/home/husiyuan/code/mtp-go_me/models/')
...
from losses import *
from ME_ExternalAttention import *
...
class LitEncoderDecoder(pl.LightningModule):
    ...
    def encode_decode(self, data, batch_idx, tf_prob=0.0):
        ...
        encoder_output, mixture_coeffs = self.encoder(data)  # [993, 11, 64]
        ...
        for di in range(target_length):
            ...
            # TODO：每个GNNdecoder 输出的next_states加 全局attetion
