    ...
    def create_net(n_states, n_inputs, n_hidden, n_layers=2):
        ...
        while i < n_layers:
            if i == 0:
                ...
                # f.append(KANLinear(n_inputs, n_hidden))
            else:
                # f.append(KANLinear(n_hidden, n_hidden))
            ...
            if not len(f):
                ...
                # f.append(KANLinear(n_inputs, n_outputs))
            else:
                f.append(nn.Linear(n_hidden, n_outputs))
                # f.append(KANLinear(n_hidden, n_outputs))
        return f
    ...
    def create_net(n_states, n_inputs, n_hidden, n_layers=2):
        ...
        while i < n_layers:
            ...
            if not len(f):
                ...
                # f.append(KANLinear(n_inputs, 1))
            else:
                # f.append(KANLinear(n_hidden, 1))
