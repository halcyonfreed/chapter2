...
# https://cloud.tencent.com/developer/article/2418826

# https://cloud.tencent.com/developer/article/1495400
# lstm gru对比
...
# input_size, hidden_size, num_heads, layers,
# batch_first=False, proj_factor_slstm=4/3, proj_factor_mlstm=2):
    # 初始化 xLSTM 模块
    block = xLSTM(input_size, hidden_size, num_heads = 3, num_layers, )
