...
SEARCH_PATH = "/mnt/home/husiyuan/code/mtp-go_me/data_sets/rounD"
INPUT_LENGTH = 3
PRED_HORIZON = 5
N_IN_FEATURES = 9
N_OUT_FEATURES = 7
...
if __name__ == "__main__":
    ...
    # rec_ids = ['0' + str(f) if len(str(f)) < 2 else str(f) for f in range(0, 23 + 1)]
    rec_ids = ['0' + str(f) if len(str(f)) < 2 else str(f) for f in range(9, 23 + 1)]
    ...
    for r_id in rec_ids:
        ...
        if r_id == '00':
            ...
            p0 = (81.1796093796538, -47.04150080448024)
        else:
        ...
        if r_id == '03':
            ...
            # tracks = remove_selected_vehicles(tracks, (13, 14, 16), rm=True)
            continue
